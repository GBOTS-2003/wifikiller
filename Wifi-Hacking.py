...
def intro():
    ...
    print("""\033[1;32m
---------------------------------------------------------------------------------------
         __        _____ _____ ___   _  _____ _     _     _____ ____  
         \ \      / /_ _|  ___|_ _| | |/ /_ _| |   | |   | ____|  _ \ 
          \ \ /\ / / | || |_   | |  | ' / | || |   | |   |  _| | |_) |
           \ V  V /  | ||  _|  | |  | . \ | || |___| |___| |___|  _ < 
            \_/\_/   |__|_|   |___| |_|\_\___|_____|_____|_____|_| \_\
                                                        Coded By GBOTS
---------------------------------------------------------------------------------------                                                                     
...
""")
        ...
        print("""
Hi.
My Name is GBOT, A Ethical Hacker,Bug Bounty Hunter,Currently Working as Cyber Security Researcher.
